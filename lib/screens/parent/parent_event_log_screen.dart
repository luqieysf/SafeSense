...
class ParentEventLogScreen extends StatefulWidget {
  const ParentEventLogScreen({super.key});

  @override
  State<ParentEventLogScreen> createState() =>
      _ParentEventLogScreenState();
}

class _ParentEventLogScreenState extends State<ParentEventLogScreen> {
  ...
  String?   _childId;      // ← passed from selection screen

  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      // get childId passed as argument
